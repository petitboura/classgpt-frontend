...
// l'ancienne redirection "/" -> "/programme" (qui traitait un onglet
// existant comme accueil par défaut, pas un vrai accueil). Placée à
// l'intérieur du groupe (app) (voir app/(app)/layout.tsx) pour hériter
